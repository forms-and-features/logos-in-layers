...
001_layers_baseline/run-latest/output-Qwen2.5-72B-records-prism.csv
001_layers_baseline/run-latest/output-Qwen2.5-72B-pure-next-token-prism.csv

If present, also include the Tuned‑Lens sidecar CSVs (same schema) for comparison:
001_layers_baseline/run-latest/output-Qwen2.5-72B-records-tuned.csv
001_layers_baseline/run-latest/output-Qwen2.5-72B-pure-next-token-tuned.csv
...
001_layers_baseline/run-latest/output-Qwen2.5-72B-pure-next-token-rawlens-window.csv
...
001_layers_baseline/run-latest/output-Qwen2.5-72B-pure-next-token-rawlens.csv
...
- EVAL output file: 001_layers_baseline/run-latest/evaluation-Qwen2.5-72B.md
