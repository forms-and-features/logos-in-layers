...
001_layers_baseline/run-latest/output-Yi-34B-pure-next-token-prism.csv

If present, also include the Tuned‑Lens sidecar CSVs (same schema) for comparison:
001_layers_baseline/run-latest/output-Yi-34B-records-tuned.csv
001_layers_baseline/run-latest/output-Yi-34B-pure-next-token-tuned.csv
...
001_layers_baseline/run-latest/output-Yi-34B-pure-next-token-rawlens-window.csv
...
001_layers_baseline/run-latest/output-Yi-34B-pure-next-token-rawlens.csv
...
- EVAL output file: 001_layers_baseline/run-latest/evaluation-Yi-34B.md
