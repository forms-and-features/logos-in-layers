...
001_layers_baseline/run-latest/output-gemma-2-9b-records-prism.csv
001_layers_baseline/run-latest/output-gemma-2-9b-pure-next-token-prism.csv

If present, also include the Tuned‑Lens sidecar CSVs (same schema) for comparison:
001_layers_baseline/run-latest/output-gemma-2-9b-records-tuned.csv
001_layers_baseline/run-latest/output-gemma-2-9b-pure-next-token-tuned.csv
...
001_layers_baseline/run-latest/output-gemma-2-9b-pure-next-token-rawlens-window.csv
...
001_layers_baseline/run-latest/output-gemma-2-9b-pure-next-token-rawlens.csv
...
- EVAL output file: 001_layers_baseline/run-latest/evaluation-gemma-2-9b.md
